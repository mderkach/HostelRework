...
<head>
    ...
    <title>Восьмиместный номер (для женщин) — Хостел Фьюжн</title>
...
<body>
    ...
    <div class="room-heading">
        <div class="container">
            <div class="column">
                <h2 class="room-header text-center">Восьмиместный номер (для женщин)</h2>
            </div>
        </div>
    </div>
    <div class="room-info">
            ...
            <div class="row">
                    ...
                    <div id="slider-room" class="flexslider-room position-relative">
                        <ul class="slides">
                            <li class="slide-thumb-big">
                                <img src="../uploads/2015/03/IMG_6800-HDR-750x500.jpg" />
                            </li>
                            <li class="slide-thumb-big">
                                <img src="../uploads/2015/03/IMG_6803-HDR-750x500.jpg" />
                            </li>
                            <li class="slide-thumb-big">
                                <img src="../uploads/2015/03/IMG_6806-HDR-750x500.jpg" />
                            </li>
                        </ul>
                    ...
                    <div id="carousel-room" class="flexslider-room-carousel">
                        <ul class="slides">
                            <li class="slide-thumb">
                                <img src="../uploads/2015/03/IMG_6800-HDR-150x150.jpg" />
                            </li>
                            <li class="slide-thumb">
                                <img src="../uploads/2015/03/IMG_6803-HDR-150x150.jpg" />
                            </li>
                            <li class="slide-thumb">
                                <img src="../uploads/2015/03/IMG_6806-HDR-150x150.jpg" />
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="d-none d-lg-block col-lg-3 offset-lg-1 sidebar-form-wrapper sticky-top sticky-offset">
                    ...
                    <form action="../handlers/order.php" id="form_order" method="post" class="sidebar-form form">
                        ...
                        <input name="room" value="Восьмиместный номер (для женщин)" type="hidden">
        ...
        <div class="container">
            <div class="row flex-column flex-md-row">
                ...
                <div class="col-12 col-md-4">
                    ...
                    <div class="socials-footer">"https://vk.com/hostelfusion" target="_blank"><img src="../images/socials-neon/vk.png" alt="" class="socials-neon"></a>
                        <a href="https://www.instagram.com/hostelfusion/" target="_blank"><img src="../images/socials-neon/instagram.png" alt="" class="socials-neon"></a>
                        <a href="https://facebook.com/fusionhostel/" target="_blank"><img src="../images/socials-neon/facebook.png" alt="" class="socials-neon"></a>
                    </div>
                </div>
