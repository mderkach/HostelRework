...
<head>
    ...
    <title>Номер на 8 человек (мужской) — Хостел Фьюжн</title>
...
-->
    ...
    <div class="room-heading">
        <div class="container">
            <div class="column">
                <h2 class="room-header text-center">Номер на 8 человек (мужской)</h2>
            </div>
        </div>
    </div>
    <div class="room-info">
            ...
            <div class="row">
                    ...
                    <div id="slider-room" class="flexslider-room position-relative">
                        <ul class="slides">
                            <li class="slide-thumb-big">
                                <img src="../uploads/2018/04/72751791-750x500.jpg" />
                            </li>
                            <li class="slide-thumb-big">
                                <img src="../uploads/2018/04/72751792-750x500.jpg" />
                            </li>
                            <li class="slide-thumb-big">
                                <img src="../uploads/2018/04/72751794-1-750x500.jpg" />
                            </li>
                        </ul>
                    ...
                    <div id="carousel-room" class="flexslider-room-carousel">
                        <ul class="slides">
                            <li class="slide-thumb">
                                <img src="../uploads/2018/04/72751791-150x150.jpg" />
                            </li>
                            <li class="slide-thumb">
                                <img src="../uploads/2018/04/72751792-150x150.jpg" />
                            </li>
                            <li class="slide-thumb">
                                <img src="../uploads/2018/04/72751794-1-150x150.jpg" />
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="d-none d-lg-block col-lg-3 offset-lg-1 sidebar-form-wrapper sticky-top sticky-offset">
                    ...
                    <form action="../handlers/order.php" id="form_order" method="post" class="sidebar-form form">
                        ...
                        <input name="room" value="Номер на 8 человек (мужской)" type="hidden">
