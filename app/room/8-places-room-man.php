...
<head>
    ...
    <title>Восьмиместный номер (для мужчин) — Хостел Фьюжн</title>
            ...
            <div class="row">
                ...
                <div class="d-none d-lg-block col-lg-3 offset-lg-1 sidebar-form-wrapper sticky-top sticky-offset">
                    ...
                    <form action="../handlers/order.php" id="form_order" method="post" class="sidebar-form form">
                        ...
                        <input name="room" value="Восьмиместный номер (для мужчин)" type="hidden">
...
-->
    ...
    <div class="popup popup-find" id="find-hostel">
        <div class="container">
            <h2 class="text-center">Получить подбор хостелов в течение 5-ти минут</h2>
            <p class="text-center">Заполните поля ниже сейчас</p>
            <form action="./handlers/get_hostel.php" method="post" class="form">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-12">
                        <input type="submit" class="btn btn-red btn-order" value="Получить подбор хостелов">
                    </div>
                </div>
            </form>
        </div>
