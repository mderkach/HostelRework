...
<head>
    ...
    <title>Трёхместный номер — Хостел Фьюжн</title>
...
<body>
    ...
    <div class="room-heading">
        <div class="container">
            <div class="column">
                <h2 class="room-header text-center">Трёхместный номер</h2>
            </div>
        </div>
    </div>
    <div class="room-info">
            ...
            <div class="row">
                    ...
                    <div id="slider-room" class="flexslider-room position-relative">
                        <ul class="slides">
                            <li class="slide-thumb-big">
                                <img src="../uploads/2017/11/IMG_1808-HDR-750x500.jpg" />
                            </li>
                            <li class="slide-thumb-big">
                                <img src="../uploads/2017/11/IMG_1814-HDR-750x500.jpg" />
                            </li>
                            <li class="slide-thumb-big">
                                <img src="../uploads/2017/11/IMG_1817-HDR-750x500.jpg" />
                            </li>
                            <li class="slide-thumb-big">
                                <img src="../uploads/2017/11/IMG_1820-HDR-750x500.jpg" />
                            </li>
                        </ul>
                    ...
                    <div id="carousel-room" class="flexslider-room-carousel">
                        <ul class="slides">
                            <li class="slide-thumb">
                                <img src="../uploads/2017/11/IMG_1808-HDR-150x150.jpg" />
                            </li>
                            <li class="slide-thumb">
                                <img src="../uploads/2017/11/IMG_1814-HDR-150x150.jpg" />
                            </li>
                            <li class="slide-thumb">
                                <img src="../uploads/2017/11/IMG_1817-HDR-150x150.jpg" />
                            </li>
                            <li class="slide-thumb">
                                <img src="../uploads/2017/11/IMG_1820-HDR-150x150.jpg" />
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="d-none d-lg-block col-lg-3 offset-lg-1 sidebar-form-wrapper sticky-top sticky-offset">
                    ...
                    <form action="../handlers/order.php" id="form_order" method="post" class="sidebar-form form">
                        ...
                        <input name="room" value="Трёхместный номер" type="hidden">
                ...
                <div class="col-12 col-lg-3 room-spec-wrapper">
                    <p>Стоимость: <strong>1 800 <span class="rub">₽</span>/ночь</strong></p>
                    <p>Кровать: <strong>3</strong></p>
                    <p>Макс. кол-во человек: <strong>3</strong></p>
                    <p>Площадь комнаты: <strong>13 м<sup>2</sup></strong></p>
