                ...
                <div class="col-12 col-lg-8 slider-wrapper">
                    <div id="slider-room" class="flexslider-room position-relative">
                        <ul class="slides">
                            ...
                            <li class="slide-thumb-big">
                                <img src="../uploads/2017/11/IMG_1766-HDR-1-750x500.jpg" />
                            </li>
                            <li class="slide-thumb-big">
                                <img src="../uploads/2017/11/IMG_1781-HDR-750x500.jpg" />
                            </li>
                            <li class="slide-thumb-big">
                                <img src="../uploads/2017/11/IMG_1872-750x500.jpg" />
                            </li>
                        </ul>
                    ...
                    <div id="carousel-room" class="flexslider-room-carousel">
                        <ul class="slides">
                            ...
                            <li class="slide-thumb">
                                <img src="../uploads/2017/11/IMG_1766-HDR-1-150x150.jpg" />
                            </li>
                            <li class="slide-thumb">
                                <img src="../uploads/2017/11/IMG_1781-HDR-150x150.jpg" />
                            </li>
                            <li class="slide-thumb">
                                <img src="../uploads/2017/11/IMG_1872-150x150.jpg" />
                            </li>
                        </ul>
                    </div>
                </div>
