...
<head>
    ...
    <title>Одноместный номер — Хостел Фьюжн</title>
...
-->
    ...
    <div class="room-heading">
        <div class="container">
            <div class="column">
                <h2 class="room-header text-center">Одноместный номер</h2>
            </div>
        </div>
    </div>
    <div class="room-info">
            ...
            <div class="row">
                    ...
                    <div id="slider-room" class="flexslider-room position-relative">
                        <ul class="slides">
                            <li class="slide-thumb-big">
                                <img src="../uploads/2017/08/one-bed-room-2.png" />
                            </li>
                            <li class="slide-thumb-big">
                                <img src="../uploads/2017/08/one-bed-room-1.png" />
                            </li>
                            <li class="slide-thumb-big">
                                <img src="../uploads/2017/08/fusuion-24-750x500.jpg" />
                            </li>
                            <li class="slide-thumb-big">
                                <img src="../uploads/2017/08/fusuion-26-750x500.jpg" />
                            </li>
                        </ul>
                    ...
                    <div id="carousel-room" class="flexslider-room-carousel">
                        <ul class="slides">
                            <li class="slide-thumb">
                                <img src="../uploads/2017/08/one-bed-room-2-150x150.png" />
                            </li>
                            <li class="slide-thumb">
                                <img src="../uploads/2017/08/one-bed-room-1-150x150.png" />
                            </li>
                            <li class="slide-thumb">
                                <img src="../uploads/2017/08/fusuion-24-150x150.jpg" />
                            </li>
                            <li class="slide-thumb">
                                <img src="../uploads/2017/08/fusuion-26-150x150.jpg" />
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="d-none d-lg-block col-lg-3 offset-lg-1 sidebar-form-wrapper sticky-top sticky-offset">
                    ...
                    <form action="../handlers/order.php" id="form_order" method="post" class="sidebar-form form">
                        ...
                        <input name="room" value="Одноместный номер" type="hidden">
                ...
                <div class="col-12 col-lg-3 room-spec-wrapper">
                    <p>Стоимость: <strong>1 500 <span class="rub">₽</span>/ночь</strong></p>
                    <p>Кровать: <strong>1</strong></p>
                    <p>Макс. кол-во человек: <strong>16</strong></p>
                    <p>Площадь комнаты: <strong>7 м<sup>2</sup></strong></p>
