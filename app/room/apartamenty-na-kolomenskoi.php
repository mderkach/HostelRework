...
<head>
    ...
    <title>Апартаменты на Коломенской — Хостел Фьюжн</title>
            ...
            <div class="row">
                ...
                <div class="d-none d-lg-block col-lg-3 offset-lg-1 sidebar-form-wrapper sticky-top sticky-offset">
                    ...
                    <form action="../handlers/order.php" id="form_order" method="post" class="sidebar-form form">
                        ...
                        <input name="room" value="Апартаменты на Коломенской" type="hidden">
                        <input name="hostel" value="Коломенская" type="hidden">
