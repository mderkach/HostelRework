...
<head>
    ...
    <title>Семейный номер — Хостел Фьюжн</title>
...
-->
    ...
    <div class="room-heading">
        <div class="container">
            <div class="column">
                <h2 class="room-header text-center">Семейный номер</h2>
            </div>
        </div>
    </div>
    <div class="room-info">
            ...
            <div class="row">
                    ...
                    <div id="slider-room" class="flexslider-room position-relative">
                        <ul class="slides">
                            <li class="slide-thumb-big">
                                <img src="../uploads/2017/08/IMG_6692-HDR-750x500.jpg" />
                            </li>
                            <li class="slide-thumb-big">
                                <img src="../uploads/2017/08/IMG_6695-HDR-750x500.jpg" />
                            </li>
                            <li class="slide-thumb-big">
                                <img src="../uploads/2017/08/IMG_6698-HDR-750x500.jpg" />
                            </li>
                            <li class="slide-thumb-big">
                                <img src="../uploads/2017/08/IMG_6703-HDR-750x500.jpg" />
                            </li>
                        </ul>
                    ...
                    <div id="carousel-room" class="flexslider-room-carousel">
                        <ul class="slides">
                            <li class="slide-thumb">
                                <img src="../uploads/2017/08/IMG_6692-HDR-150x150.jpg" />
                            </li>
                            <li class="slide-thumb">
                                <img src="../uploads/2017/08/IMG_6695-HDR-150x150.jpg" />
                            </li>
                            <li class="slide-thumb">
                                <img src="../uploads/2017/08/IMG_6698-HDR-150x150.jpg" />
                            </li>
                            <li class="slide-thumb">
                                <img src="../uploads/2017/08/IMG_6703-HDR-150x150.jpg" />
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="d-none d-lg-block col-lg-3 offset-lg-1 sidebar-form-wrapper sticky-top sticky-offset">
                    ...
                    <form action="../handlers/order.php" id="form_order" method="post" class="sidebar-form form">
                        ...
                        <input name="room" value="Семейный номер" type="hidden">
                ...
                <div class="col-12 col-lg-3 room-spec-wrapper">
                    <p>Стоимость: <strong>2 600 <span class="rub">₽</span>/ночь</strong></p>
                    <p>Кровать: <strong>2 односпальные, 1 двухъярусная</strong></p>
                    <p>Макс. кол-во человек: <strong>4</strong></p>
