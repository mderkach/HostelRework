            ...
            <div class="row">
                ...
                <div class="d-none d-lg-block col-lg-3 offset-lg-1 sidebar-form-wrapper sticky-top sticky-offset">
                    ...
                    <form action="../handlers/order.php" id="form_order" method="post" class="sidebar-form form">
                        ...
                        <input name="room" value="Двухкомнатный номер с ТВ" type="hidden">
                        <input name="hostel" value="Проспект мира" type="hidden">
                        <div class="form-group">
                            <input required="" type="text" class="form-control" placeholder="Дата заезда" onfocus="(this.type='date')" />
                        </div>
                        <div class="form-group">
                            <input required="" type="text" class="form-control" placeholder="Дата отъезда" onfocus="(this.type='date')" />
                        </div>
                        <div class="form-group">
