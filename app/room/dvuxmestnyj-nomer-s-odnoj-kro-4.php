...
<head>
    ...
    <title>Двухместный номер с одной двуспальной кроватью — Хостел Фьюжн</title>
...
-->
    ...
    <div class="room-heading">
        <div class="container">
            <div class="column">
                <h2 class="room-header text-center">Двухместный номер с одной двуспальной кроватью</h2>
            </div>
        </div>
    </div>
    <div class="room-info">
            ...
            <div class="row">
                    ...
                    <div id="slider-room" class="flexslider-room position-relative">
                        <ul class="slides">
                            <li class="slide-thumb-big">
                                <img src="../uploads/2017/11/IMG_1595-HDR-750x500.jpg" />
                            </li>
                            <li class="slide-thumb-big">
                                <img src="../uploads/2017/11/IMG_1598-HDR-1-750x500.jpg" />
                            </li>
                            <li class="slide-thumb-big">
                                <img src="../uploads/2017/11/IMG_1616-HDR-750x500.jpg" />
                            </li>
                            <li class="slide-thumb-big">
                                <img src="../uploads/2017/11/IMG_1631-HDR-1-750x500.jpg" />
                            </li>
                            <li class="slide-thumb-big">
                                <img src="../uploads/2017/11/IMG_1640-HDR-750x500.jpg" />
                            </li>
                            <li class="slide-thumb-big">
                                <img src="../uploads/2017/11/IMG_1670-HDR-750x500.jpg" />
                            </li>
                        </ul>
                    ...
                    <div id="carousel-room" class="flexslider-room-carousel">
                        <ul class="slides">
                            <li class="slide-thumb">
                                <img src="../uploads/2017/11/IMG_1595-HDR-150x150.jpg" />
                            </li>
                            <li class="slide-thumb">
                                <img src="../uploads/2017/11/IMG_1598-HDR-1-150x150.jpg" />
                            </li>
                            <li class="slide-thumb">
                                <img src="../uploads/2017/11/IMG_1616-HDR-150x150.jpg" />
                            </li>
                            <li class="slide-thumb">
                                <img src="../uploads/2017/11/IMG_1631-HDR-1-150x150.jpg" />
                            </li>
                            <li class="slide-thumb">
                                <img src="../uploads/2017/11/IMG_1640-HDR-150x150.jpg" />
                            </li>
                            <li class="slide-thumb">
                                <img src="../uploads/2017/11/IMG_1670-HDR-150x150.jpg" />
                            </li>
                        </ul>
                    </div>
                </div>
                <div class="d-none d-lg-block col-lg-3 offset-lg-1 sidebar-form-wrapper sticky-top sticky-offset">
                    ...
                    <form action="../handlers/order.php" id="form_order" method="post" class="sidebar-form form">
                        ...
                        <input name="room" value="Двухместный номер с одной двуспальной кроватью" type="hidden">
                ...
                <div class="col-12 col-lg-3 room-spec-wrapper">
                    <p>Стоимость: <strong>1 900 <span class="rub">₽</span>/ночь</strong></p>
                    ...
                    <div id="accordion" role="tablist" aria-multiselectable="true" class="collapse-info">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div id="collapseFive" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                                ...
                                <p>Юридический адрес:115280, г. Москва, ул. Восточная, дом 2 корпус 5/51 Тел.: 8 (800) 551-97-84</p>
                            </div>
                        </div>
                    </div>
                </div>
